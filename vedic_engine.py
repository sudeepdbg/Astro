"""
Vedic Astrology Calculation Engine v5.1
========================================
FULLY CORRECTED version with all prediction rules included.
- Added house_map and lord_map as properties to ChartData (fixes AttributeError)
...
- Varshphal: full Solar Return chart calculation (house_map now works)
...
# ==================================================================
# SECTION 4 — CHART DATA CLASS (with house_map property)
# ==================================================================
